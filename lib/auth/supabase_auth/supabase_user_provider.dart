...
class LocalservicewaleSupabaseUser extends BaseAuthUser {
  LocalservicewaleSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> localservicewaleSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = LocalservicewaleSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
