...
import 'user_srv_req_list_model.dart';
export 'user_srv_req_list_model.dart';

class UserSrvReqListWidget extends StatefulWidget {
  const UserSrvReqListWidget({super.key});

  @override
  State<UserSrvReqListWidget> createState() => _UserSrvReqListWidgetState();
}

class _UserSrvReqListWidgetState extends State<UserSrvReqListWidget> {
  late UserSrvReqListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserSrvReqListModel());
  }
