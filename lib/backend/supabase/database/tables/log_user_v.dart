...
class LogUserVTable extends SupabaseTable<LogUserVRow> {
  @override
  String get tableName => 'log_user_v';

  @override
  LogUserVRow createRow(Map<String, dynamic> data) => LogUserVRow(data);
}

class LogUserVRow extends SupabaseDataRow {
  LogUserVRow(super.data);

  @override
  SupabaseTable get table => LogUserVTable();
  ...
  String? get callUser => getField<String>('call_user');
  set callUser(String? value) => setField<String>('call_user', value);

  String? get callBus => getField<String>('call_bus');
  set callBus(String? value) => setField<String>('call_bus', value);
}
